...
public class NutritionData
{
    ...
    public double ProteinBase { get; set; } = 100;
    public double Carbs { get; set; }
    public double CarbsBase { get; set; } = 100;
    public double Fat { get; set; }
    public double FatBase { get; set; } = 100;
}
...
// Recipes.json stores TimeSpan as { "ticks": N }; Cookbooks.json stores it as "00:10:00".
// One converter handles both.
