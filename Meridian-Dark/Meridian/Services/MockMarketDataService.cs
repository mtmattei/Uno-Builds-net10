...
public class MockMarketDataService : IMarketDataService
{
	...
	private static IImmutableList<Sector> BuildSectors() =>
		ImmutableList.Create(
			new Sector("Technology", 68.2, "#5CA87E"),
			new Sector("Consumer Disc.", 14.5, "#D2B278"),
			new Sector("Financials", 9.8, "#9C917C"),
			new Sector("Healthcare", 4.8, "#DA6154"),
			new Sector("Energy", 2.7, "#7C7365"));
