...
{
    // ── Theme colors ──────────────────────────────────────────────────
    private static readonly SKColor ColorTextPrimary = new(0xF2, 0xED, 0xE3);
    private static readonly SKColor ColorTextSubtle = new(0x73, 0x6B, 0x5E);
    private static readonly SKColor ColorBorder = new(0x38, 0x32, 0x28);
    private static readonly SKColor ColorAccent = new(0xD2, 0xB2, 0x78);
    // Tooltip plate is the cream ink on dark, so its label must be the ground.
    private static readonly SKColor ColorTipText = new(0x15, 0x13, 0x0F);
