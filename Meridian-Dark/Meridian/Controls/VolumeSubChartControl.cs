...
public sealed class VolumeSubChartControl : SKXamlCanvas
{
	...
	private static readonly SKColor ColorMuted = new(0x4A, 0x44, 0x39);
	private static readonly SKColor ColorHighlight = new(0x5C, 0xA8, 0x7E);
	private static readonly SKColor ColorTextPrimary = new(0xF2, 0xED, 0xE3);
	private static readonly SKColor ColorCardBg = new(0x1E, 0x1B, 0x16);
