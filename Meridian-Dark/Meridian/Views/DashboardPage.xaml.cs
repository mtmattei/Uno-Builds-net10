...
public sealed partial class DashboardPage : Page
{
    ...
    [
        // Dark ground: the orbs lift the ink rather than tinting paper, so the
        // base tones are the lifted semantics and the alphas roughly double.
        (146.8, 0.304, 0.510, 20),  // Green (#5CA87E)
        (38.7,  0.500, 0.647, 16),  // Brass (#D2B278)
        (155.0, 0.300, 0.500, 12),  // Teal-green
    ];
    ...
    private async Task LoadChartAsync(string? ticker)
    {
        try
        {
            ...
            {
                Color = isPositive ? "#5CA87E" : "#DA6154",
                IsDark = true
            };
